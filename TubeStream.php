...
if (isset($_SESSION['id']) && $_SESSION['id'] != '') {
  ...
  $text='Sign In';
    ...
    $sql="SELECT `videoname`, `description`,`uid`,`cname`,`view` FROM main ORDER BY `id` DESC";
...
<div>
    ...
    <div class="videoh" style="display:flex;flex-wrap:wrap;">
    </div>
    <div class="acc">
        <div class="login">
...
for(var i=0; i<ele.length;i++){
    ...
    function video(){
      ...
      var vview=JSON.parse(viw);
          for (var i = j; i < k; i++){
            ...
            holder.className = 'video-class-'+i+" vidh";
  ...
  window.location.href = ('_blank',url);
          ...
          videoh.style.paddingBottom="20px";
  }
  videoh.addEventListener('scroll',function () {
    checkScroll();
  })
